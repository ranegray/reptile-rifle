...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      <section
        id="hero"
        className="flex flex-col my-14 p-4 md:max-w-5xl md:mx-auto"
      >
        <div className="flex flex-col md:flex-row md:gap-8">
          <div className="mb-8 md:flex-1">
            ...
            <button className="bg-zinc-200 p-2 rounded-md my-4 font-bold hover:bg-zinc-300">
        ...
        <div className="bg-zinc-100 mt-4 border rounded-md p-4">
          <p className="text-lg">
            <span className="font-bold">Automation without the barriers.</span>{" "}
            Humanoids that drop into existing workcells—PLC-ready, redeployable,
            built for heavy-duty cycles.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <h2 className="text-2xl font-bold">
          Cut Waiting and Transport. Boost Throughput.
        </h2>
        <ValueStreamToggle />
        <div className="bg-zinc-100 mt-4 border rounded-md p-4">
          <p className="text-lg">
            <span className="font-bold">Transform your value stream.</span>{" "}
            GOLEM humanoids reduce non-value-added time, enhancing overall
            throughput and efficiency on the manufacturing floor.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <h2 className="text-2xl font-bold">
          Modular Intelligence for Industrial Work
        </h2>
      ...
      >
        <div className="flex flex-col bg-zinc-100 rounded-md border p-4">
          <div>
            ...
            <h3>
              Developed with support from the U.S. Department of Energy
              (ARPA-E).
            </h3>
            <ul className="list-disc pl-5">
      ...
      >
        ...
        <p className="my-4">
          Interested in learning more about GOLEM humanoids or scheduling a
          pilot deployment? Reach out to our team to explore how we can help
